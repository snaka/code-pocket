...
This is a sample template for cf-viewer-request-handler - Below is a brief explanation of what we have generated for you:
...
sam deploy \
    ...
    --stack-name cf-viewer-request-handler \
...
aws cloudformation describe-stacks \
    --stack-name cf-viewer-request-handler --query 'Stacks[].Outputs'
```
